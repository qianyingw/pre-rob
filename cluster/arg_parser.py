...
def get_args():
    ...
    parser.add_argument('--exp_name', nargs="?", type=str, default="exp_1", help='Experiment name for building the folder')
    parser.add_argument('--rob_name', nargs="?", type=str, default="random", 
    ...
    parser.add_argument('--embed_path', nargs="?", type=str, default='/home/qwang/rob/wordvec/wikipedia-pubmed-and-PMC-w2v.txt', help='Path of pre-trained vectors')
    parser.add_argument('--data_json_path', nargs="?", type=str, default='/home/qwang/rob/data/psycho/rob_psycho_fulltokens.json', help='Path of data in json format')
